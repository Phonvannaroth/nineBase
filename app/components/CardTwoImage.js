    ...
    return (
        <View>
            ...
            <View style={styles.card} >
                <ImageBackground source={require('../img/agent.jpg')} style={styles.img} />
                <View style={{ marginTop: 15, width: cardWidth * 1.6 }}>
                    <Text style={styles.txtHeader}>Find out how much you could earn hosting your place</Text>
                    <Text style={styles.txtDetail}>Turn your extra space into extra income.</Text>
